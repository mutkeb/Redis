...
class YkdTest {
    ...
    private void assertData() throws Exception {
        ...
        Assert.notNull(p1.getUser(), "personalRecord 模型实例中需要设置关联的用户实例");
        Assert.notNull(p2.getUser(), "personalRecord 模型实例中需要设置关联的用户实例");
        ...
        Assert.notNull(p21.getUser(), "personalRecord 模型实例中需要设置关联的用户实例");
        Assert.notNull(p22.getUser(), "personalRecord 模型实例中需要设置关联的用户实例");
