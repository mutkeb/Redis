...
public class UserServiceImpl implements UserService {
    ...
    public Result<User> register(String userName, String pwd) {
        ...
        UserDO userDO = (UserDO)redisTemplate.opsForHash().get(CACHE_KEY, userName);
        ...
        redisTemplate.opsForHash().put(CACHE_KEY, userName, userDO1);
    ...
    public Result<User> login(String userName, String pwd) {
        ...
        if (userDO == null) {
            ...
            if (userDO == null) {
                ...
                redisTemplate.opsForHash().put(CACHE_KEY, userName, userDO);
            }
        }
    ...
    public User findById(Long id) {
        ...
        //  首先从缓存中寻找
        UserDO userDO = (UserDO) redisTemplate.opsForHash().get(CACHE_MODEL_KEY, id);
        if(userDO == null){
            //  从数据库种寻找
            ...
            //  数据库中有数据，将其存入缓存
            redisTemplate.opsForHash().put(CACHE_MODEL_KEY,id,userDO);
        }
